        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-teal-500 to-cyan-500 bg-clip-text text-transparent">NeuroSynapse</span>
            </Link>
            <p className="text-slate-500 dark:text-slate-400 mb-4 max-w-md">
              Explicaciones simples sobre cómo funciona nuestra mente y cómo aplicarlo al día a día. Conversaciones dinámicas, casos reales, consejos prácticos y entrevistas con expertos.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/episodes" className="text-slate-500 dark:text-slate-400 hover:text-teal-500 transition-colors">
                  Episodios
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-slate-500 dark:text-slate-400 hover:text-teal-500 transition-colors">
                  Contacto
                </Link>
              </li>
            </ul>
